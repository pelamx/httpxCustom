...
import (
	...
	"github.com/pelamx/httpxCustom/internal/testutils"
...
var httpTestcases = map[string]testutils.TestCase{
	...
	"Regression test for: https://github.com/pelamx/httpxCustom/issues/363":           &issue363{},           // infinite redirect
	"Regression test for: https://github.com/pelamx/httpxCustom/issues/276":           &issue276{},           // full path with port in output
	"Regression test for: https://github.com/pelamx/httpxCustom/issues/277":           &issue277{},           // scheme://host:port via stdin
	"Regression test for: https://github.com/pelamx/httpxCustom/issues/303":           &issue303{},           // misconfigured gzip header with uncompressed body
	"Regression test for: https://github.com/pelamx/httpxCustom/issues/400":           &issue400{},           // post operation with body
	"Regression test for: https://github.com/pelamx/httpxCustom/issues/414":           &issue414{},           // stream mode with path
	"Regression test for unwanted chars":                                                  &titleUnwantedChars{}, // new line scanning with title flag, Regression test for: https://github.com/pelamx/httpxCustom/issues/433
	"Request URI to existing file - https://github.com/pelamx/httpxCustom/issues/480": &issue480{},           // request uri pointing to existing file
